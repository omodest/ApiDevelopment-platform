...
//
//import static api.development.platform.constant.CommonConstant.SMS_BUCKET_PREFIX;
//
///**
// * 令牌桶算法，一个时间段内，存在一定数量的令牌，我们需要拿到令牌才可以继续操作。
// */
//@Component
...
//        String key = SMS_BUCKET_PREFIX + phoneNum;
//        // 计算令牌桶内令牌数

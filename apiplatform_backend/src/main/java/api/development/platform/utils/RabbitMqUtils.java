...
//
//    private final String SMS_BUCKET_PREFIX = "telephone";
//
//    /**
//     * 向mq中投递发送短信消息
//     *
...
//            redisTemplate.opsForHash().putAll(SMS_BUCKET_PREFIX + messageId, messageArgs);
//            redisTemplate.expire(SMS_BUCKET_PREFIX + messageId, 10, TimeUnit.MINUTES);
//
//            String finalMessageId = messageId;
//            finalId = messageId;
//            this.smsDTO = smsDTO;
//            // 将消息投递到MQ，并设置消息的一些参数
//            rabbitTemplate.convertAndSend(SMS_BUCKET_PREFIX, SMS_BUCKET_PREFIX, smsDTO, message -> {
...
//            redisTemplate.delete(SMS_BUCKET_PREFIX + messageId);
//            redisTemplate.opsForHash().put(SMS_BUCKET_PREFIX, messageId, smsDTO);
...
//        if (b) {
//            redisTemplate.opsForHash().put(SMS_BUCKET_PREFIX + finalId, "status", 1);
//        } else {
//            // 发送失败，放入redis失败集合中，并删除集合数据
//            log.error("短信消息投送失败：{}-->{}", correlationData, s);
//            redisTemplate.delete(SMS_BUCKET_PREFIX + finalId);
//            redisTemplate.opsForHash().put(SMS_BUCKET_PREFIX, finalId, this.smsDTO);
//        }
//    }
//
//    /**

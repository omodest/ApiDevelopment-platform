//package api.development.platform.listener;
//
//import api.development.platform.model.dto.user.SmsDTO;
//import api.development.platform.utils.SendSmsUtils;
...
//        int retryCount = (int) redisTemplate.opsForHash().get(SMS_MESSAGE_PREFIX + messageId, "retryCount");
//        if (retryCount > 3) {
//            //重试次数大于3，直接放到死信队列
...
//            redisTemplate.delete(SMS_MESSAGE_PREFIX + messageId);
//            return;
//        }
//        try {
...
//            redisTemplate.delete(   SMS_MESSAGE_PREFIX + messageId);
//        } catch (Exception e) {
//            redisTemplate.opsForHash().put(SMS_MESSAGE_PREFIX+messageId,"retryCount",retryCount+1);

...
/** listProductOrderByPage GET /api/order/order/list/page */
export async function listProductOrderByPageUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.listProductOrderByPageUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseOrderVo_>('/api/order/order/list/page', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** listProductInfoByPage GET /api/order/product/list/page */
export async function listProductInfoByPageUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.listProductInfoByPageUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponsePageProductInfo_>('/api/order/product/list/page', {
    method: 'GET',
    params: {
      ...params,
    },

...
import api.development.platform.model.dto.post.PostAddRequest;
import api.development.platform.model.dto.post.PostEditRequest;
...
public class PostController {
    ...
    public BaseResponse<Long> addPost(@RequestBody PostAddRequest postAddRequest, HttpServletRequest request) {
        ...
        Post post = new Post();
        BeanUtils.copyProperties(post, postAddRequest); // 将 第二个javabean中的属性复制到第一个javabean
